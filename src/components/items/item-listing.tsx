...
export const ItemListingComponent: React.FC<ItemListingComponentProps> = ({
    data,
}) => {
    ...
    const TreeItemComponent: React.FC<{ item: ITreeItem; level?: number }> = ({
        item,
        level = 0,
    }) => {
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                                onSelect={(e) => {
                                    ...
                                    alert(
                                        `Clone functionality for "${item.name}" would be implemented here`
                                    );
                                }}
                            >
